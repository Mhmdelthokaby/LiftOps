...
**Purpose**:  
The Collins-BackEnd system is a comprehensive management solution for an elevator and escalator company. It handles inventory management, installation project workflows, and administrative user management.
...
### Identity & Common
#### **[AppUser](file:///c:/Users/mhmd/Desktop/Collins/Collins-BackEnd.Domain/Entities/AppUser.cs)**
...
### Inventory Module
#### **[InventoryItem](file:///c:/Users/mhmd/Desktop/Collins/Collins-BackEnd.Domain/Entities/InventoryItem.cs)**
...
### Installation Module
#### **[Customer](file:///c:/Users/mhmd/Desktop/Collins/Collins-BackEnd.Domain/Entities/Installation/Customer.cs)**
*   **Table**: `Customers`
*   **Properties**: `Name`, `Phone`, `Email`, `Address`, `ProjectNumber`.
*   **Note**: `ProjectNumber` is stored on Customer as per current design.

#### **[InstallationProject](file:///c:/Users/mhmd/Desktop/Collins/Collins-BackEnd.Domain/Entities/Installation/InstallationProject.cs)**
...
#### **[Elevator](file:///c:/Users/mhmd/Desktop/Collins/Collins-BackEnd.Domain/Entities/Installation/Elevator.cs)**
*   **Table**: `Elevators`
*   **Properties**: `ProjectId` (FK), `ElevatorType`, `NumberOfStops`, `NumberOfFloors`.

#### **[InstallationStage](file:///c:/Users/mhmd/Desktop/Collins/Collins-BackEnd.Domain/Entities/Installation/InstallationStage.cs)**
...
#### **[StageRequiredPart](file:///c:/Users/mhmd/Desktop/Collins/Collins-BackEnd.Domain/Entities/Installation/StageRequiredPart.cs)**
*   **Table**: `StageRequiredParts`
*   **Properties**: `StageId` (FK), `InventoryItemId` (FK), `Quantity`, `IsOutOfStock` (bool).

#### [Technician](file:///c:/Users/mhmd/Desktop/Collins/Collins-BackEnd.Domain/Entities/Installation/Technician.cs)
*   **Table**: `Technicians`
...
#### [TechnicianAssignment](file:///c:/Users/mhmd/Desktop/Collins/Collins-BackEnd.Domain/Entities/Installation/TechnicianAssignment.cs)
...
### [AdminController](file:///c:/Users/mhmd/Desktop/Collins/Collins-BackEnd.API/Controllers/AdminController.cs)
**Route**: `api/Admin`
...
### [InventoryController](file:///c:/Users/mhmd/Desktop/Collins/Collins-BackEnd.API/Controllers/InventoryController.cs)
**Route**: `api/Inventory`
...
### [InstallationController](file:///c:/Users/mhmd/Desktop/Collins/Collins-BackEnd.API/Controllers/InstallationController.cs)
...
### [TechnicianController](file:///c:/Users/mhmd/Desktop/Collins/Collins-BackEnd.API/Controllers/TechnicianController.cs)
...
### Constants
*   `Roles`: Defined in `Collins_BackEnd.Domain.Common.Roles` (`Manager`, `InstallationAdmin`, etc.).
...
2.  **Setup**:
    ...
    *   Run `dotnet ef database update --project Collins-BackEnd.Infrastructure --startup-project Collins-BackEnd.API`.
    *   (Optional) Seeding happens automatically on startup.
3.  **Run**:
    *   `dotnet run --project Collins-BackEnd.API`
...
This section helps frontend developers quickly integrate with the Collins-BackEnd.
...
For a full list of endpoints and DTO structures, see [API_ENDPOINTS.md](file:///c:/Users/mhmd/Desktop/Collins-Project/Collins/API_ENDPOINTS.md).
