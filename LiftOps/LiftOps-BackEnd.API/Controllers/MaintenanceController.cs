...
using LiftOps_BackEnd.Application.Features.Maintenance.Commands.AddChecklistItem;
using LiftOps_BackEnd.Application.Features.Maintenance.Commands.UpdateChecklistItem;
using LiftOps_BackEnd.Application.Features.Maintenance.Commands.DeleteChecklistItem;
using LiftOps_BackEnd.Application.Features.Maintenance.Commands.CreateMaintenanceProject;
using LiftOps_BackEnd.Application.Features.Maintenance.Commands.MarkVisitAsPaid;
...
using LiftOps_BackEnd.Application.Features.Maintenance.Commands.ActivateElevator;
...
using LiftOps_BackEnd.Application.Features.Maintenance.Commands.ActivateContract;
using LiftOps_BackEnd.Application.Features.Maintenance.Queries.ListChecklistItems;
using LiftOps_BackEnd.Application.Features.Maintenance.Queries.GetAllMaintenanceContracts;
using LiftOps_BackEnd.Application.Features.Maintenance.Queries.CheckProjectNumberExists;
using LiftOps_BackEnd.Application.Features.Maintenance.Queries.GetMaintenanceContractDetails;
using LiftOps_BackEnd.Application.Features.Maintenance.Queries.GetAllMaintenanceElevators;
using LiftOps_BackEnd.Application.Features.Maintenance.Queries.GetVisitsByContractAndMonth;
using LiftOps_BackEnd.Application.Features.Maintenance.Queries.GetVisitsByElevator;
using LiftOps_BackEnd.Application.Features.Maintenance.Queries.GetMaintenanceStatistics;
using LiftOps_BackEnd.Application.Features.Maintenance.Commands.AssignVisitToTechnician;
...
namespace LiftOps_BackEnd.API.Controllers
{
    ...
    public class MaintenanceController : ControllerBase
    {
        ...
        {
            var service = HttpContext.RequestServices.GetRequiredService<LiftOps_BackEnd.Application.Interfaces.Maintenance.IMaintenanceService>();
