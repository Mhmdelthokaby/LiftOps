...
3. **Verify** `NEXT_PUBLIC_API_URL` is set correctly:
   ```
   NEXT_PUBLIC_API_URL=https://collins-management.runasp.net
   ```
...
4. **Add/Edit Variable**:
   ...
   - **Value**: `https://collins-management.runasp.net`
...
**Expected Output:**
```
[API Config] API Base URL: https://collins-management.runasp.net
```
...
4. Check the login request URL - it should be:
   ```
   https://collins-management.runasp.net/api/Admin/login
   ```
   NOT:
   ```
...
- [ ] Value is correct: `https://collins-management.runasp.net` (no trailing slash)
...
- Should see: `[API Config] API Base URL: https://collins-management.runasp.net`
- Try login → Network tab → Should see requests to `https://collins-management.runasp.net/api/Admin/login`
...
2. Verify the API URL is accessible (try opening `https://collins-management.runasp.net/api/dashboard/summary` in browser)
