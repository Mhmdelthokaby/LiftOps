...
1. **Create `.env.local` file** in the `collins-frontend` directory (same level as `package.json`)
...
**Solutions**:
1. ✅ Make sure `.env.local` file exists in `collins-frontend` directory
...
2. ✅ Ensure file is in the root of `collins-frontend` directory
