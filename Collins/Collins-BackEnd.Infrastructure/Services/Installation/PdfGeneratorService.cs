...
namespace Collins_BackEnd.Infrastructure.Services.Installation
{
    public class PdfGeneratorService : IPdfGenerator
    {
        ...
        {
            var logoPath = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot/collins.png");
            ...
            return Document.Create(container =>
            {
                container.Page(page =>
                {
                    ...
                    page.Header().Row(row =>
                    {
                        ...
                        {
                            col.Item().Text("Collins Elevators & Escalators").FontSize(16).SemiBold();
                    ...
                    page.Footer().Column(col =>
                    {
                        ...
                        col.Item().Row(row =>
                        {
                            ...
                            {
                                c.Item().Text("Collins Elevators & Escalators").FontSize(8).SemiBold();
                                c.Item().Text("Customer Service: 01022223207 | Email: info@Collinslift.com").FontSize(8);
                            });
