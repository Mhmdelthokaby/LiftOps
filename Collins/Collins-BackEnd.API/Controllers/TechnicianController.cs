using Collins_BackEnd.Application.Features.Maintenance.Queries.GetTechnicianVisitsForToday;
...
using Collins_BackEnd.Application.Features.Technicians.Queries;
using Collins_BackEnd.Application.Features.Emergency.Queries;
